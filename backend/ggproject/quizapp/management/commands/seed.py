...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # Creating Quizzes
        quiz_sustainability_transport = Quiz.objects.create(topic_id=1, topic_title = "Everyday Sustainability", quiz_title="Recycle and Reuse", topic_image="http://127.0.0.1:8000/assets/everyday.png", q1 =question_everyday_1, q2=question_everyday_2, q3=question_everyday_3, q4=question_everyday_4, q5=question_everyday_5, q6=question_everyday_6, order=1)
        quiz_types_renewable_energy = Quiz.objects.create(topic_id=2, topic_title="Renewable Energy", quiz_title="Types of Renewable Energy", topic_image="http://127.0.0.1:8000/assets/renewable.png", q1=question_renewable_type_1, q2=question_renewable_type_2, q3=question_renewable_type_3, q4=question_renewable_type_4, q5=question_renewable_type_5, q6=question_renewable_type_6, order=1)
        quiz_types_conserve_at_home = Quiz.objects.create(topic_id=2, topic_title="Renewable Energy", quiz_title="Conserve Energy at Home", topic_image="http://127.0.0.1:8000/assets/renewable.png", q1=question_conserve_at_home_1, q2=question_conserve_at_home_2, q3=question_conserve_at_home_3, q4=question_conserve_at_home_4, q5=question_conserve_at_home_5, q6=question_conserve_at_home_6, order=2)
        quiz_species_extinction = Quiz.objects.create(topic_id=3, topic_title = "Conservation Efforts", quiz_title="Species in Danger of Extinction", topic_image="http://127.0.0.1:8000/assets/wildlife.png", q1 =question_extinction_1, q2=question_extinction_2, q3=question_extinction_3, q4=question_extinction_4, q5=question_extinction_5, q6=question_extinction_6, order=1)
        quiz_canada_conservation = Quiz.objects.create(topic_id=3, topic_title = "Conservation Efforts", quiz_title="Wildlife Conservation in Canada", topic_image="http://127.0.0.1:8000/assets/wildlife.png", q1 =question_canada_conservation_1, q2=question_canada_conservation_2, q3=question_canada_conservation_3, q4=question_canada_conservation_4, q5=question_canada_conservation_5, q6=question_canada_conservation_6, order=2)
        quiz_forest_conservation = Quiz.objects.create(topic_id=3, topic_title = "Conservation Efforts", quiz_title="Protecting Our Forests", topic_image="http://127.0.0.1:8000/assets/wildlife.png", q1 =question_conservation_forests_1, q2=question_conservation_forests_2, q3=question_conservation_forests_3, q4=question_conservation_forests_4, q5=question_conservation_forests_5, q6=question_conservation_forests_6, order=3)
        quiz_marine_life_conservation = Quiz.objects.create(topic_id=3, topic_title="Conservation Efforts", quiz_title="Ocean and Marine Life", topic_image="http://127.0.0.1:8000/assets/wildlife.png", q1=question_marine_life_1, q2=question_marine_life_2, q3=question_marine_life_3, q4=question_marine_life_4, q5=question_marine_life_5, q6=question_marine_life_6, order=4)
        quiz_sustainable_farming = Quiz.objects.create(topic_id=4, topic_title = "Sustainable Agriculture", quiz_title="Sustainable Farming Practices", topic_image="http://127.0.0.1:8000/assets/farming.png", q1 =question_sustainable_farming_1, q2=question_sustainable_farming_2, q3=question_sustainable_farming_3, q4=question_sustainable_farming_4, q5=question_sustainable_farming_5, q6=question_sustainable_farming_6, order=1)
